...
**MMS** is a comprehensive, self-hosted Maintenance Management System (MMS) designed to simplify and automate maintenance operations.

### 🌟 Why MMS?

- ✅ **Self-Hosted** - Full control over your data and infrastructure
- ✅ **Open Source** - Transparent, customizable, and community-driven
- ✅ **Docker-Based** - Easy deployment and scalability
...
- **Real-Time Monitoring** - Integrated Grafana dashboards for live asset monitoring
- **InfluxDB Integration** - Time-series data storage for sensor data and metrics
- **Asset-Specific Dashboards** - Configure individual monitoring dashboards per asset
- **Global Alerting Dashboard** - Centralized view of all alerts and critical events
- **Embedded Visualization** - Dashboards embedded directly in MMS interface
- **External Data Sources** - Connect IoT sensors and monitoring systems to InfluxDB
- **Custom Metrics** - Define and track custom KPIs for your assets
- **Alert Management** - Visual representation of system alerts and anomalies
...
- **Floor Plan Integration** - Visual location mapping
...
4. **Access the application**:
   ...
   - API UI: http://localhost:12001/swagger-ui.html
   - MinIO Console: http://localhost:9001
   - InfluxDB UI: http://localhost:8086
   - Grafana Dashboards: http://localhost:3001
   

5. **Initialize monitoring services** (optional):
   ```bash
...
6. **Default credentials**:
   ...
   - InfluxDB/Grafana credentials are set in `.env` file
...
- ⚠️ Any modifications must also be open-sourced under GPL-3.0
...
- 📖 **Documentation**: Check the [dev-docs](dev-docs/) folder
...
<div align="center">
  <p>Made with ❤️ by the MMS Team</p>
