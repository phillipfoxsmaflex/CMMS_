...
public class GlobalExceptionHandlerController {
    ...
    public ResponseEntity<SuccessResponse> handleException(HttpServletResponse res, Exception ex) {
        ...
        // Handle ServletException that might wrap CustomException from JwtTokenFilter
        if (ex instanceof ServletException && ex.getCause() instanceof CustomException) {
            CustomException customEx = (CustomException) ex.getCause();
            log.error("CustomException wrapped in ServletException: {}", customEx.getMessage(), customEx);
