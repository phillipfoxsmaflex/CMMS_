...
public class LocationService {
    ...
    public Location create(Location location, Company company) {
        ...
        applicationEventPublisher.publishEvent(new LocationCreatedEvent(savedLocation));
    ...
    @Transactional
    public Location setDashboardConfig(Long locationId, String url, String config) {
        Optional<Location> optionalLocation = findById(locationId);
        if (optionalLocation.isPresent()) {
            Location location = optionalLocation.get();
            location.setDashboardUrl(url);
            location.setDashboardConfig(config);
