...
import com.grash.dto.EnhancedSignupResponse;
...
public class UserService {
    ...
    private EnhancedSignupResponse<OwnUser> enableAndReturnToken(OwnUser user, boolean sendEmailToSuperAdmins,
        ...
        return new EnhancedSignupResponse<>(true, "Registration successful", token, false, user);
    }

    public EnhancedSignupResponse<OwnUser> signup(UserSignupRequest userReq) {
        ...
        if (Helper.isLocalhost(PUBLIC_API_URL)) {
            ...
            return new EnhancedSignupResponse<>(true, "Successful registration. Check your mailbox to activate your account", null, true, null);
        }
