            ...
            for (Role upToDateRole : upToDateRoles) {
                if (existingDefaultRole.getCode().equals(upToDateRole.getCode())) {
                    ...
                    if (!CollectionUtils.isEqualCollection(existingDefaultRole.getCreatePermissions(),
                            ...
                            || !CollectionUtils.isEqualCollection(existingDefaultRole.getEditPermissions(),
                            upToDateRole.getEditPermissions())
                            || !CollectionUtils.isEqualCollection(existingDefaultRole.getDeletePermissions(),
                            upToDateRole.getDeletePermissions())
                        ...
                        existingDefaultRole.getEditPermissions().clear();
                        existingDefaultRole.getEditPermissions().addAll(upToDateRole.getEditPermissions());
                        existingDefaultRole.getDeletePermissions().clear();
                        existingDefaultRole.getDeletePermissions().addAll(upToDateRole.getDeletePermissions());
