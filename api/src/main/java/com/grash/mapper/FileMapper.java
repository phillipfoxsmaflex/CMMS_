...
public abstract class FileMapper {
    ...
    private String getSignedUrl(File file) {
        ...
        // Expiration time in MINUTES (not seconds!)
        // 6 hours = 360 minutes - good balance between caching and security
        return storageService.generateSignedUrl(file.getPath(), 360);
    }
}
