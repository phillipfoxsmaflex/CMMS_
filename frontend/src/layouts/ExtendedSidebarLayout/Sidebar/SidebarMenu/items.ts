...
const ownMenuItems: MenuItems[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        permission: PermissionEntity.DOCUMENTS,
        uiConfigKey: 'documents'
      },
