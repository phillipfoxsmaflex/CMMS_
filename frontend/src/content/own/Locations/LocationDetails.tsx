...
import LocationFloorPlanMap from './LocationFloorPlanMap';
import LocationDashboardSettings from '../AssetMonitoring/LocationDashboardSettings';
      ...
      <Grid item xs={12}>
        ...
        {currentTab === 'floorPlans' && (
          <Box>
            ...
            <LocationFloorPlanMap locationId={location.id} />
            
            {/* Floor Plan Management List */}
            {floorPlans.length > 0 && (
              <Box mt={3}>
                <Typography variant="h6" gutterBottom>
                  {t('Manage Floor Plans')}
                </Typography>
                <List sx={{ width: '100%' }}>
        ...
        {currentTab === 'dashboard' && (
          <LocationDashboardSettings location={location} />
        )}
      </Grid>
    </Grid>
  );
