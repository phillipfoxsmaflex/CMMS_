const locale = {
  ...
  key_features_description:
    'Some of the features that make {{shortBrandName}} one of the best maintenance management solutions available today',
  ...
  permit_delete_failure: 'Failed to delete permit',
  permit_approved: 'Permit approved successfully',
  permit_approve_failure: 'Failed to approve permit',
  permit_rejected: 'Permit rejected successfully',
  permit_reject_failure: 'Failed to reject permit',
  permit_activated: 'Permit activated successfully',
  permit_activate_failure: 'Failed to activate permit',
  permit_completed: 'Permit completed successfully',
  permit_complete_failure: 'Failed to complete permit',
  permit_cancelled: 'Permit cancelled successfully',
  permit_cancel_failure: 'Failed to cancel permit',
  permits_description: 'Manage work permits and safety authorizations',
  add_permit: 'Add Permit',
  add_permit_description: 'Create a new work permit',
  edit_permit: 'Edit Permit',
  edit_permit_description: 'Update permit details',
  create_permit: 'Create Permit',
  no_permits: 'No permits found',
  confirm_delete_permit: 'Are you sure you want to delete this permit?',
  reject_permit: 'Reject Permit',
  enter_permit_title: 'Enter permit title',
  permit_type: 'Permit Type',
  select_permit_type: 'Select permit type',
  required_permit_type: 'Permit type is required',
  risk_level: 'Risk Level',
  select_risk_level: 'Select risk level',
  required_risk_level: 'Risk level is required',
  safety_requirements: 'Safety Requirements',
  enter_safety_requirements: 'Enter safety requirements',
  equipment_needed: 'Equipment Needed',
  enter_equipment_needed: 'Enter equipment needed',
  ...
  required_rejection_reason: 'Rejection reason is required',
  // Permit status translations (DRAFT, PENDING, APPROVED, REJECTED, CANCELLED already exist)
  ACTIVE: 'Active',
  COMPLETED: 'Completed',
  ...
  COLD_WORK: 'Cold Work',
  OTHER: 'Other',
  // Risk level translations (HIGH, MEDIUM, LOW already exist)
  // Permit location translations
  permit_location_create_success: 'Permit location created successfully',
  permit_location_create_failure: 'Failed to create permit location',
  permit_location_edit_failure: 'Failed to update permit location',
  permit_location_delete_success: 'Permit location deleted successfully',
  permit_location_delete_failure: 'Failed to delete permit location',
  permit_locations_description: 'Manage locations for work permits',
  add_permit_location: 'Add Permit Location',
  add_permit_location_description: 'Create a new permit location',
  edit_permit_location: 'Edit Permit Location',
  edit_permit_location_description: 'Update permit location details',
  create_permit_location: 'Create Permit Location',
  no_permit_locations: 'No permit locations found',
  confirm_delete_permit_location: 'Are you sure you want to delete this permit location?',
  enter_facility: 'Enter facility name',
  ...
  moc_create_success: 'Management of Change created successfully',
  moc_create_failure: 'Failed to create Management of Change',
  moc_edit_failure: 'Failed to update Management of Change',
  moc_delete_success: 'Management of Change deleted successfully',
  moc_delete_failure: 'Failed to delete Management of Change',
  moc_approved: 'Management of Change approved successfully',
  moc_approve_failure: 'Failed to approve Management of Change',
  moc_rejected: 'Management of Change rejected successfully',
  moc_reject_failure: 'Failed to reject Management of Change',
  moc_description: 'Manage changes to permits and processes',
  add_moc: 'Add Management of Change',
  add_moc_description: 'Create a new Management of Change request',
  edit_moc: 'Edit Management of Change',
  edit_moc_description: 'Update Management of Change details',
  create_moc: 'Create Management of Change',
  no_mocs: 'No Management of Change records found',
  confirm_delete_moc: 'Are you sure you want to delete this Management of Change?',
  reject_moc: 'Reject Management of Change',
  enter_moc_title: 'Enter title',
  change_type: 'Change Type',
  select_change_type: 'Select change type',
  required_change_type: 'Change type is required',
  risk_assessment: 'Risk Assessment',
  enter_risk_assessment: 'Enter risk assessment',
  required_risk_assessment: 'Risk assessment is required',
  ...
  'mobile-app.title': 'A mobile maintenance app that empowers your maintenance team',
  ...
  select_safety_tasks: 'Select Safety Measures',
  ...
  contractor_calendar: 'Contractor Calendar',
  ...
  assign_safety_tasks_description: 'Assign Custom Safety Measures',
  ...
  WEBHOOK: 'A webhook is triggered',
  ALERT_NAME_IS: 'Alert name is',
  SEVERITY_IS: 'Severity is',
  ...
  upload_logo_description: 'Upload your company logo to customize the application appearance',
  logo_preview: 'Logo Preview',
  logo_requirements: 'Recommended size: 200x200 pixels, PNG or JPG format',
  remove_logo: 'Remove Logo',
  
  // Asset Monitoring
  asset_monitoring: 'Asset Monitoring',
  alerting_dashboard: 'Alerting Dashboard',
  asset_dashboards: 'Asset Dashboards',
  location_dashboards: 'Location Dashboards',
  dashboard_url: 'Dashboard URL',
  dashboard_settings: 'Dashboard Settings',
  edit_dashboard_settings: 'Edit Dashboard Settings',
  save_dashboard_settings: 'Save Dashboard Settings',
  alerting_dashboard_settings: 'Alerting Dashboard Settings',
  alerting_dashboard_url: 'Alerting Dashboard URL',
  alerting_dashboard_url_help: 'Enter the Grafana dashboard URL for global alerting overview',
  dashboard_url_help: 'Enter the Grafana dashboard URL for this asset',
  no_dashboard_configured: 'No dashboard configured',
  asset_not_found: 'Asset not found',
  configure_dashboard: 'Configure Dashboard',
  dashboard_config_saved: 'Dashboard configuration saved successfully',
  error_saving_dashboard_config: 'Error saving dashboard configuration',
  alerting_dashboard_settings_saved: 'Alerting dashboard settings saved successfully',
  error_saving_alerting_dashboard_settings: 'Error saving alerting dashboard settings',
  view_dashboard: 'View Dashboard',
  asset_monitoring_description: 'Monitor your assets in real-time with integrated Grafana dashboards'
};
