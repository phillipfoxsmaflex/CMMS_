...
import {
  ...
  getContractorEmployeesByCustomer
...
const ContractorEmployeeList: React.FC<{ vendorId?: number; customerId?: number }> = ({ vendorId, customerId }) => {
  ...
  useEffect(() => {
    if (vendorId) {
      ...
      dispatch(getContractorEmployeesByCustomer(customerId));
    } else {
  ...
  }, [dispatch, page, rowsPerPage, vendorId, customerId, searchQuery]);
  ...
  const handleEdit = (id: number) => {
    navigate(`/app/contractors/employees/${id}/edit`);
  };
