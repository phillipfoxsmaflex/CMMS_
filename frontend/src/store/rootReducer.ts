...
import { reducer as webhookReducer } from 'src/slices/webhook';
...
import { reducer as contractorAssignmentReducer } from 'src/slices/contractorAssignment';
...
const rootReducer = combineReducers({
  ...
  contractorAssignments: contractorAssignmentReducer
});
